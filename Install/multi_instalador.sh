...
MIP_CMD="/bin/mip"
SSHPLUS_SCRIPT="https://raw.githubusercontent.com/sam53et/SSHPLUS-ZAMET/master"  # github bağlantısı düzeltildi
...
atualizar() {
  ...
  fun_bar fun_att
  echo -e "\n\033[1;33m GÜNCELLEME BAŞARILI -\033[1;32m OK !\033[1;37m"
  sleep 2
...
remove_multiscripts() {
  rm -f $HOME/sshplus.sh /bin/mip
  echo -e "\n\033[1;31mBaşarıyla kaldırıldı.\033[0m"
}
...
menu() {
  while true; do
    ...
    echo -e "$barra"
    echo -e "\E[41;1;37mÇOKLU KURULUM ARACI                \033[1;32m[\033[1;37m SÜRÜM: r021 \033[1;32m]\E[0m"
    echo -e "$barra"
    echo ""
    echo -e "\033[1;31m[01] \033[1;33mSSHPLUS MANAGER FREE"
    echo -e "\033[1;31m[02] \033[1;33mSSHPLUS MANAGER RESMİ (KEYS)"
    echo -e "\033[1;31m[03] \033[1;33mSSHPLUS WEB PANELİ V.20"
    echo -e "\033[1;31m[04] \033[1;33mVIP-VPS WEB PANELİ V.23"
    echo -e "\033[1;31m[05] \033[1;33mVIP-VPS WEB PANELİ V.25"
    echo -e "\033[1;31m[06] \033[1;33mGÜNCELLEME V23 ➜ V25"
    echo -e "\033[1;31m[07] \033[1;33mSSH BAYİ PANELİ (SÜRÜMLER)"
    echo -e "\033[1;31m[08] \033[1;33mSSHPLUS KEY OLUŞTURUCU"
    echo -e "\033[1;31m[09] \033[1;33mTCP-TWEAKER 1.0"
    echo -e "\033[1;31m[10] \033[1;35m[!] GÜNCELLE \033[1;31m(RAM: $RAM)"
    echo -e "\033[1;31m[11] \033[1;35m[!] MIP KALDIR \033[1;31m(CPU: $CPU)"
    echo -e "\033[1;31m[00] \033[1;37mÇIKIŞ"
    echo -e "$barra"
    echo ""
    read -p $'\033[1;32mNE YAPMAK İSTİYORSUNUZ? \033[1;33m» \033[1;37m' opcao
    ...
    case "$opcao" in
      ...
      0 | 00)
        ...
        break
        ;;
      *) echo -e "\n\033[1;31mGeçersiz seçenek!\033[0m" && sleep 2 ;;
    esac
  done
}
